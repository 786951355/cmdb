# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-03-16 02:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myassets.Asset')),
        ...
        migrations.AddField(
            model_name='asset',
            name='group',
            field=models.ManyToManyField(blank=True, to='myassets.AssetGroup', verbose_name='所属主机组'),
        ),
        migrations.AddField(
            model_name='asset',
            name='idc',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='myassets.IDC', verbose_name='机房'),
        ),
    ]
